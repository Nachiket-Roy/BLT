...
(function () {
  ...
  function removePrize (event, prizeId, organizationId) {
    ...
    const prizeContainer = document.getElementById(`prize-container-${prizeId}`);
  ...
  function editPrize (event, prizeId, prizeName, cashValue, noOfProjects, validSubmissions, description, organizationId) {
    ...
    document.getElementById('every_valid_submissions').checked = !!validSubmissions;
  ...
  function updatePrize (prizeId, organizationId) {
    const prize_name = document.getElementById('prize_name');
    const cash_value = document.getElementById('cash_value');
    const number_of_winning_projects = document.getElementById('number_of_winning_projects');
    const every_valid_submissions = document.getElementById('every_valid_submissions');
