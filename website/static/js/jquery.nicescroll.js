/* jquery.nicescroll 3.5.0 InuYaksa*2013 MIT http://areaaperta.com/nicescroll */(function (e) {
  let z = !1; let E = !1; let L = 5E3; let M = 2E3; let y = 0; const N = (function () { var e = document.getElementsByTagName('script'); var e = e[e.length - 1].src.split('?')[0]; return e.split('/').length > 0 ? e.split('/').slice(0, -1).join('/') + '/' : ''; }()); const H = ['ms', 'moz', 'webkit', 'o']; let v = window.requestAnimationFrame || !1; let w = window.cancelAnimationFrame || !1; if (!v) for (const O in H) { const F = H[O]; v || (v = window[F + 'RequestAnimationFrame']); w || (w = window[F + 'CancelAnimationFrame'] || window[F + 'CancelRequestAnimationFrame']); } const A = window.MutationObserver || window.WebKitMutationObserver ||
    ...
    function k () { let d = b.win; if ('zIndex' in d) return d.zIndex(); for (;d.length > 0 && d[0].nodeType != 9;) { const c = d.css('zIndex'); if (!isNaN(c) && c != 0) return parseInt(c); d = d.parent(); } return !1; } function l (d, c, f) { c = d.css(c); d = parseFloat(c); return isNaN(d) ? (d = u[c] || 0, f = d == 3 ? f ? b.win.outerHeight() - b.win.innerHeight() : b.win.outerWidth() - b.win.innerWidth() : 1, b.isie8 && d && (d += 1), f ? d : 0) : d; } function q (d, c, f, g) {
      ...
      let g, e; d.deltaMode == 0
        ? (g = -Math.floor(d.deltaX * (b.opt.mousescrollstep / 54)), e = -Math.floor(d.deltaY *
    (b.opt.mousescrollstep / 54)))
        : d.deltaMode == 1 && (g = -Math.floor(d.deltaX * b.opt.mousescrollstep), e = -Math.floor(d.deltaY * b.opt.mousescrollstep)); c && (b.opt.oneaxismousemode && g == 0 && e) && (g = e, e = 0); g && (b.scrollmom && b.scrollmom.stop(), b.lastdeltax += g, b.debounced('mousewheelx', function () { const d = b.lastdeltax; b.lastdeltax = 0; b.rail.drag || b.doScrollLeftBy(d); }, 120)); if (e) {
        ...
        b.scrollmom && b.scrollmom.stop(); b.lastdeltay += e; b.debounced('mousewheely', function () { const d = b.lastdeltay; b.lastdeltay = 0; b.rail.drag || b.doScrollBy(d); }, 120);
...
(this.istouchcapable = !0, g.cantouch = !1); g.cantouch && (g.ismozilla && !g.isios && !g.isandroid) && (this.istouchcapable = !0, g.cantouch = !1); b.opt.enablemouselockapi || (g.hasmousecapture = !1, g.haspointerlock = !1); this.delayed = function (d, c, f, g) {
      const e = b.delaylist[d]; const k = (new Date()).getTime(); if (!g && e && e.tt) return !1; e && e.tt && clearTimeout(e.tt); if (e && e.last + f > k && !e.tt)b.delaylist[d] = { last: k + f, tt: setTimeout(function () { b.delaylist[d].tt = 0; c.call(); }, f) }; else if (!e || !e.tt) {
        b.delaylist[d] = { last: k, tt: 0 }, setTimeout(function () { c.call(); },
          0);
      }
    }; this.debounced = function (d, c, f) { const g = b.delaylist[d]; (new Date()).getTime(); b.delaylist[d] = c; g || setTimeout(function () { const c = b.delaylist[d]; b.delaylist[d] = !1; c.call(); }, f); }; this.synched = function (d, c) { b.synclist[d] = c; (function () { b.onsync || (v(function () { b.onsync = !1; for (d in b.synclist) { const c = b.synclist[d]; c && c.call(b); b.synclist[d] = !1; } }), b.onsync = !0); })(); return d; }; this.unsynched = function (d) { b.synclist[d] && (b.synclist[d] = !1); }; this.css = function (d, c) {
      for (const f in c) {
      ...
      getNow: function () { const b = 1 - ((new Date()).getTime() - this.ts) / this.spd; const c = this.B2(b) + this.B3(b) + this.B4(b); return b < 0 ? this.ed : this.st + Math.round(this.df * c); },
      ...
      this.doc.translate = { x: 0, y: 0, tx: '0px', ty: '0px' }; g.hastranslate3d && g.isios && this.doc.css('-webkit-backface-visibility', 'hidden'); const s = function () {
        ...
        : document.fireEvent ? function (b) { const c = document.createEventObject(); b.fireEvent('onscroll'); c.cancelBubble = !0; } : function (b, c) {}; g.hastranslate3d && b.opt.enabletranslate3d
        ? (this.setScrollTop = function (d, c) { b.doc.translate.y = d; b.doc.translate.ty = -1 * d + 'px'; b.doc.css(g.trstyle, 'translate3d(' + b.doc.translate.tx + ',' + b.doc.translate.ty + ',0px)'); c || b.notifyScrollEvent(b.win[0]); }, this.setScrollLeft = function (d, c) {
    ...
    function () { return b.docscroll.scrollTop(); }, this.setScrollTop = function (d) { return b.docscroll.scrollTop(d); }, this.getScrollLeft = function () { return b.docscroll.scrollLeft(); }, this.setScrollLeft = function (d) { return b.docscroll.scrollLeft(d); };
      ...
      if (b.ishwscroll)b.rail.css({ height: b.win.innerHeight() }), b.railh && b.railh.css({ width: b.win.innerWidth() }); else {
        const c = b.getOffset(); var f = c.top; var g = c.left; var f = f + l(b.win, 'border-top-width', !0); b.win.outerWidth(); b.win.innerWidth(); var g = g + (b.rail.align
          ? b.win.outerWidth() -
    l(b.win, 'border-right-width') - b.rail.width
          : l(b.win, 'border-left-width')); const e = b.opt.railoffset; e && (e.top && (f += e.top), b.rail.align && e.left && (g += e.left)); b.locked || b.rail.css({ top: f, left: g, height: d ? d.h : b.win.innerHeight() }); b.zoom && b.zoom.css({ top: f + 1, left: b.rail.align == 1 ? g - 20 : g + b.rail.width + 4 }); b.railh && !b.locked && (f = c.top, g = c.left, d = b.railh.align ? f + l(b.win, 'border-top-width', !0) + b.win.innerHeight() - b.railh.height : f + l(b.win, 'border-top-width', !0), g += l(b.win, 'border-left-width'), b.railh.css({
          top: d,
          left: g,
          width: b.railh.width
        }));
      }
    }; this.doRailClick = function (d, c, f) { let g; b.locked || (b.cancelEvent(d), c ? (c = f ? b.doScrollLeft : b.doScrollTop, g = f ? (d.pageX - b.railh.offset().left - b.cursorwidth / 2) * b.scrollratio.x : (d.pageY - b.rail.offset().top - b.cursorheight / 2) * b.scrollratio.y, c(g)) : (c = f ? b.doScrollLeftBy : b.doScrollBy, g = f ? b.scroll.x : b.scroll.y, d = f ? d.pageX - b.railh.offset().left : d.pageY - b.rail.offset().top, f = f ? b.view.w : b.view.h, g >= d ? c(f) : c(-f))); }; b.hasanimationframe = v; b.hascancelanimationframe = w; b.hasanimationframe
      ? b.hascancelanimationframe ||
    (w = function () { b.cancelAnimationFrame = !0; })
      : (v = function (b) { return setTimeout(b, 15 - Math.floor(+new Date() / 1E3) % 16); }, w = clearInterval); this.init = function () {
    ...
    0;
          ...
          ? (f.css({ position: 'fixed', top: '0px', height: '100%' }), f.align ? f.css({ right: '0px' }) : f.css({ left: '0px' }), b.body.append(f), b.railh && (m.css({ position: 'fixed', left: '0px', width: '100%' }), m.align ? m.css({ bottom: '0px' }) : m.css({ top: '0px' }), b.body.append(m)))
          : (b.ishwscroll
            ? (b.win.css('position') == 'static' && b.css(b.win, { position: 'relative' }), d = b.win[0].nodeName == 'HTML' ? b.body : b.win, b.zoom && (b.zoom.css({
              position: 'absolute',
              top: 1,
              right: 0,
              'margin-right': f.width + 4
            }), d.append(b.zoom)), f.css({ position: 'absolute', top: 0 }), f.align ? f.css({ right: 0 }) : f.css({ left: 0 }), d.append(f), m && (m.css({ position: 'absolute', left: 0, bottom: 0 }), m.align ? m.css({ bottom: 0 }) : m.css({ top: 0 }), d.append(m)))
            : (b.isfixed = b.win.css('position') == 'fixed', d = b.isfixed ? 'fixed' : 'absolute', b.isfixed || (b.viewport = b.getViewport(b.win[0])), b.viewport && (b.body = b.viewport, !1 == /fixed|relative|absolute/.test(b.viewport.css('position')) && b.css(b.viewport, { position: 'relative' })),
            f.css({ position: d }), b.zoom && b.zoom.css({ position: d }), b.updateScrollBar(), b.body.append(f), b.zoom && b.body.append(b.zoom), b.railh && (m.css({ position: d }), b.body.append(m))), g.isios && b.css(b.win, { '-webkit-tap-highlight-color': 'rgba(0,0,0,0)', '-webkit-touch-callout': 'none' }), g.isie && b.opt.disableoutline && b.win.attr('hideFocus', 'true'), g.iswebkit && b.opt.disableoutline && b.win.css({ outline: 'none' })); !1 === b.opt.autohidemode
          ...
          : !0 === b.opt.autohidemode || b.opt.autohidemode === 'leave'
            ? (b.autohidedom = e().add(b.rail), g.isie8 && (b.autohidedom = b.autohidedom.add(b.cursor)), b.railh && (b.autohidedom = b.autohidedom.add(b.railh)), b.railh && g.isie8 && (b.autohidedom = b.autohidedom.add(b.cursorh)))
        ...
        (b.autohidedom = !1, b.hide(), b.locked = !1); if (g.isie9mobile) {
          b.scrollmom = new J(b), b.onmangotouch = function (d) {
            d = b.getScrollTop(); const c = b.getScrollLeft(); if (d == b.scrollmom.lastscrolly && c == b.scrollmom.lastscrollx) return !0; let f = d - b.mangotouch.sy; const g = c - b.mangotouch.sx; if (Math.round(Math.sqrt(Math.pow(g, 2) + Math.pow(f, 2))) != 0) {
              const n = f < 0 ? -1 : 1; const e = g < 0 ? -1 : 1; const k = +new Date(); b.mangotouch.lazy && clearTimeout(b.mangotouch.lazy); k - b.mangotouch.tm > 80 || b.mangotouch.dry != n || b.mangotouch.drx != e
                ? (b.scrollmom.stop(), b.scrollmom.reset(c,
                  d), b.mangotouch.sy = d, b.mangotouch.ly = d, b.mangotouch.sx = c, b.mangotouch.lx = c, b.mangotouch.dry = n, b.mangotouch.drx = e, b.mangotouch.tm = k)
                : (b.scrollmom.stop(), b.scrollmom.update(b.mangotouch.sx - g, b.mangotouch.sy - f), b.mangotouch.tm = k, f = Math.max(Math.abs(b.mangotouch.ly - d), Math.abs(b.mangotouch.lx - c)), b.mangotouch.ly = d, b.mangotouch.lx = c, f > 2 && (b.mangotouch.lazy = setTimeout(function () { b.mangotouch.lazy = !1; b.mangotouch.dry = 0; b.mangotouch.drx = 0; b.mangotouch.tm = 0; b.scrollmom.doMomentum(30); }, 100)));
            }
          }, f = b.getScrollTop(),
              ...
              if (d.pointerType && d.pointerType != 2) return !1; if (!b.locked) {
                if (g.hasmstouch) {
                  for (var c = d.target ? d.target : !1; c;) {
                    var f = e(c).getNiceScroll(); if (f.length > 0 && f[0].me == b.me) break; if (f.length > 0) return !1; if (c.nodeName == 'DIV' && c.id == b.id) break; c = c.parentNode
                      ? c.parentNode
                      : !1;
                  }
    ...
    'f';
              ...
              if (d.pointerType && d.pointerType != 2) return !1; if (b.rail.drag && b.rail.drag.pt == 2) {
                if (g.cantouch && typeof d.original === 'undefined') return !0; b.hasmoving = !0; b.preventclick && !b.preventclick.click && (b.preventclick.click = b.preventclick.tg.onclick || !1, b.preventclick.tg.onclick =
    b.onpreventclick); d = e.extend({ original: d }, d); 'changedTouches' in d && (d.clientX = d.changedTouches[0].clientX, d.clientY = d.changedTouches[0].clientY); if (b.forcescreen) { var f = d; d = { original: d.original ? d.original : d }; d.clientX = f.screenX; d.clientY = f.screenY; }f = ofy = 0; if (t && !c) { var n = b.win.position(); var f = -n.left; ofy = -n.top; } let k = d.clientY + ofy; var n = k - b.rail.drag.y; let l = d.clientX + f; var h = l - b.rail.drag.x; let r = b.rail.drag.st - n; b.ishwscroll && b.opt.bouncescroll
                  ? r < 0
                    ? r = Math.round(r / 2)
                    : r > b.page.maxh && (r = b.page.maxh + Math.round((r - b.page.maxh) /
    2))
                  : (r < 0 && (k = r = 0), r > b.page.maxh && (r = b.page.maxh, k = 0)); if (b.railh && b.railh.scrollable) { var m = b.rail.drag.sl - h; b.ishwscroll && b.opt.bouncescroll ? m < 0 ? m = Math.round(m / 2) : m > b.page.maxw && (m = b.page.maxw + Math.round((m - b.page.maxw) / 2)) : (m < 0 && (l = m = 0), m > b.page.maxw && (m = b.page.maxw, l = 0)); }f = !1; if (b.rail.drag.dl)f = !0, b.rail.drag.dl == 'v' ? m = b.rail.drag.sl : b.rail.drag.dl == 'h' && (r = b.rail.drag.st); else {
    ...
    !1, !0;
                ...
                }b.synched('touchmove', function () { b.rail.drag && b.rail.drag.pt == 2 && (b.prepareTransition && b.prepareTransition(0), b.rail.scrollable && b.setScrollTop(r), b.scrollmom.update(l, k), b.railh && b.railh.scrollable ? (b.setScrollLeft(m), b.showCursor(r, m)) : b.showCursor(r), g.isie10 && document.selection.clear()); });
                g.ischrome && b.istouchcapable && (f = !1); if (f) return b.cancelEvent(d);
              }
            };
          }b.onmousedown = function (d, c) { if (!(b.rail.drag && b.rail.drag.pt != 1)) { if (b.locked) return b.cancelEvent(d); b.cancelScroll(); b.rail.drag = { x: d.clientX, y: d.clientY, sx: b.scroll.x, sy: b.scroll.y, pt: 1, hr: !!c }; const f = b.getTarget(d); !b.ispage && g.hasmousecapture && f.setCapture(); b.isiframe && !g.hasmousecapture && (b.saved.csspointerevents = b.doc.css('pointer-events'), b.css(b.doc, { 'pointer-events': 'none' })); return b.cancelEvent(d); } }; b.onmouseup = function (d) {
            if (b.rail.drag &&
    ...
    (d.clientY - b.rail.drag.y), b.scroll.y < 0 && (b.scroll.y = 0), c = b.scrollvaluemax, b.scroll.y > c && (b.scroll.y = c);
              }b.synched('mousemove', function () { b.rail.drag && b.rail.drag.pt == 1 && (b.showCursor(), b.rail.drag.hr ? b.doScrollLeft(Math.round(b.scroll.x * b.scrollratio.x), b.opt.cursordragspeed) : b.doScrollTop(Math.round(b.scroll.y * b.scrollratio.y), b.opt.cursordragspeed)); }); return b.cancelEvent(d);
            }
    ...
    -Math.floor(b.selectiondrag.df / 6)), b.debounced('doselectionscroll', function () { p(); }, 50));
            ...
            'touchcancel', b.ontouchend), b.bind(document, 'touchmove', b.ontouchmove)); b.bind(b.cursor, 'mousedown', b.onmousedown); b.bind(b.cursor, 'mouseup', b.onmouseup); b.railh && (b.bind(b.cursorh, 'mousedown', function (d) { b.onmousedown(d, !0); }), b.bind(b.cursorh, 'mouseup', function (d) { if (!(b.rail.drag && b.rail.drag.pt == 2)) return b.rail.drag = !1, b.hasmoving = !1, b.hideCursor(), g.hasmousecapture && document.releaseCapture(), b.cancelEvent(d); })); if (b.opt.cursordragontouch || !g.cantouch && !b.opt.touchbehavior) {
            ...
            b.jqbind(b.zoom, 'mouseleave', function () { b.rail.active = !1; b.rail.drag || b.hideCursor(); })))
...
(b.isiframe || b.bind(g.isie && b.ispage ? document : b.win, 'mousewheel', b.onmousewheel), b.bind(b.rail, 'mousewheel', b.onmousewheel), b.railh && b.bind(b.railh, 'mousewheel', b.onmousewheelhr)); !b.ispage && (!g.cantouch && !/HTML|BODY/.test(b.win[0].nodeName)) && (b.win.attr('tabindex') || b.win.attr({ tabindex: L++ }), b.jqbind(b.win, 'focus', function (d) { z = b.getTarget(d).id || !0; b.hasfocus = !0; b.canshowonmouseevent && b.noticeCursor(); }), b.jqbind(b.win, 'blur', function (d) { z = !1; b.hasfocus = !1; }), b.jqbind(b.win, 'mouseenter', function (d) {
    ...
    !b.ispage && !b.haswrapper) { const s = b.win.attr('style'); var f = parseFloat(b.win.css('width')) + 1; b.win.css('width', f); b.synched('chromefix', function () { b.win.attr('style', s); }); }b.onAttributeChange = function (d) { b.lazyResize(250); }; !b.ispage && !b.haswrapper && (!1 !== A
          ? (b.observer = new A(function (d) { d.forEach(b.onAttributeChange); }), b.observer.observe(b.win[0], { childList: !0, characterData: !1, attributes: !0, subtree: !1 }), b.observerremover = new A(function (d) {
    ...
    b.win[0]) return b.remove();
        ...
        const K = function (d) {
          b.iframexd = !1; try { var c = 'contentDocument' in this ? this.contentDocument : this.contentWindow.document; } catch (f) { b.iframexd = !0, c = !1; } if (b.iframexd) return !0; b.forcescreen = !0; b.isiframe && (b.iframe = { doc: e(c), html: b.doc.contents().find('html')[0], body: b.doc.contents().find('body')[0] }, b.getContentSize = function () {
            return {
    ...
    this
            ...
            : b.bind(c, 'scroll', b.onscroll); b.opt.enablemousewheel && b.bind(c, 'mousewheel', b.onmousewheel); b.opt.enablekeyboard && b.bind(c, g.isopera ? 'keypress' : 'keydown', b.onkeypress); if (g.cantouch || b.opt.touchbehavior)b.bind(c, 'mousedown', b.ontouchstart), b.bind(c, 'mousemove', function (d) { b.ontouchmove(d, !0); }), b.opt.grabcursorenabled && g.cursorgrabvalue && b.css(e(c.body), { cursor: g.cursorgrabvalue }); b.bind(c, 'mouseup', b.ontouchend); b.zoom && (b.opt.dblclickzoom && b.bind(c,
            'dblclick', b.doZoom), b.ongesturezoom && b.bind(c, 'gestureend', b.ongesturezoom));
        }; this.doc[0].readyState && this.doc[0].readyState == 'complete' && setTimeout(function () { K.call(b.doc[0], !1); }, 500); b.bind(this.doc, 'load', K);
      }
...
(b.cursortimeout = setTimeout(function () { if (!b.rail.active || !b.showonmouseevent)b.autohidedom.stop().animate({ opacity: b.opt.cursoropacitymin }), b.zoom && b.zoom.stop().animate({ opacity: b.opt.cursoropacitymin }), b.cursoractive = !1; b.cursortimeout = 0; }, d || b.opt.hidecursordelay));
    }; this.noticeCursor = function (d, c, f) { b.showCursor(c, f); b.rail.active || b.hideCursor(d); }; this.getContentSize = b.ispage
      ? function () {
        return {
    ...
    0
      ...
      b.railh && (b.railh.width = b.page.maxh > 0 ? b.view.w - b.rail.width : b.view.w, b.scrollvaluemaxw = b.railh.width - b.cursorwidth - b.cursorh.wborder); b.checkrtlmode && b.railh && (b.checkrtlmode = !1, b.opt.rtlmode && b.scroll.x == 0 && b.setScrollLeft(b.page.maxw)); b.ispage || b.updateScrollBar(b.view); b.scrollratio = { x: b.page.maxw / b.scrollvaluemaxw, y: b.page.maxh / b.scrollvaluemax }; b.getScrollTop() > b.page.maxh
        ...
        : (b.scroll.y = Math.round(b.getScrollTop() * (1 / b.scrollratio.y)), b.scroll.x = Math.round(b.getScrollLeft() *
    ...
    }; this.resize = b.onResize; this.lazyResize = function (d) { d = isNaN(d) ? 30 : d; b.delayed('resize', b.resize, d); return b; }; this._bind = function (d, c, f, g) { b.events.push({ e: d, n: c, f, b: g, q: !1 }); d.addEventListener ? d.addEventListener(c, f, g || !1) : d.attachEvent ? d.attachEvent('on' + c, f) : d['on' + c] = f; }; this.jqbind = function (d, c, f) { b.events.push({ e: d, n: c, f, q: !0 }); e(d).bind(c, f); };
    this.bind = function (d, c, f, e) {
      const k = 'jquery' in d ? d[0] : d; c == 'mousewheel'
        ? 'onwheel' in b.win ? b._bind(k, 'wheel', f, e || !1) : (d = typeof document.onmousewheel !== 'undefined' ? 'mousewheel' : 'DOMMouseScroll', q(k, d, f, e || !1), d == 'DOMMouseScroll' && q(k, 'MozMousePixelScroll', f, e || !1))
        : k.addEventListener
          ? (g.cantouch && /mouseup|mousedown|mousemove/.test(c) && b._bind(k, c == 'mousedown' ? 'touchstart' : c == 'mouseup' ? 'touchend' : 'touchmove', function (b) {
            if (b.touches) {
        ...
        b; f.call(this, d);
          ...
          }, e || !1), b._bind(k, c, f, e || !1), g.cantouch && c == 'mouseup' && b._bind(k, 'touchcancel', f, e || !1))
          : b._bind(k, c, function (d) { if ((d = d || window.event || !1) && d.srcElement)d.target = d.srcElement; 'pageY' in d || (d.pageX = d.clientX + document.documentElement.scrollLeft, d.pageY = d.clientY + document.documentElement.scrollTop); return !1 === f.call(k, d) || !1 === e ? b.cancelEvent(d) : !0; });
      ...
      b = b.original
        ? b.original
        : b || window.event || !1; if (!b) return !1; if (b.stopPropagation) return b.stopPropagation(); b.cancelBubble && (b.cancelBubble = !0); return !1;
    ...
    b.win[0].detachEvent('onpropertychange', b.onAttributeChange); !1 !== b.observer && b.observer.disconnect(); !1 !== b.observerremover && b.observerremover.disconnect(); b.events = null; b.cursor && b.cursor.remove(); b.cursorh && b.cursorh.remove(); b.rail && b.rail.remove(); b.railh && b.railh.remove(); b.zoom && b.zoom.remove(); for (let d = 0; d < b.saved.css.length; d++) { const c = b.saved.css[d]; c[0].css(c[1], typeof c[2] === 'undefined' ? '' : c[2]); }b.saved = !1; b.me.data('__nicescroll', ''); const f = e.nicescroll; f.each(function (d) {
      ...
      if (b.locked) return b.debounced('checkunlock', b.resize, 250), !0; if (b.rail.drag) return b.cancelEvent(d); b.opt.oneaxismousemode == 'auto' && d.deltaX != 0 && (b.opt.oneaxismousemode = !1); if (b.opt.oneaxismousemode && d.deltaX == 0 && !b.rail.scrollable) return b.railh && b.railh.scrollable ? b.onmousewheelhr(d) : !0; const c = +new Date(); let f = !1; b.opt.preservenativescrolling && b.checkarea + 600 < c &&
    ...
    }; this.onmousewheelhr = function (d) { if (b.locked || !b.railh.scrollable) return !0; if (b.rail.drag) return b.cancelEvent(d); const c = +new Date(); let f = !1; b.opt.preservenativescrolling && b.checkarea + 600 < c && (b.nativescrollingarea = b.isScrollable(d), f = !0); b.checkarea = c; return b.nativescrollingarea ? !0 : b.locked ? b.cancelEvent(d) : t(d, !0, f); }; this.stop = function () {
    ...
    }; this.getTransitionSpeed = function (d) { const c = Math.round(10 * b.opt.scrollspeed); d = Math.min(c, Math.round(d / 20 * b.opt.scrollspeed)); return d > 20 ? d : 0; }; b.opt.smoothscroll
    ...
    b.setScrollLeft(e); b.noticeCursor(!1, c, e); b.cursorfreezed = !1; c < 0 ? c = 0 : c > b.page.maxh && (c = b.page.maxh); e < 0 ? e = 0 : e > b.page.maxw && (e = b.page.maxw); if (c != b.newscrolly || e != b.newscrollx) return b.doScrollPos(e, c, b.opt.snapbackspeed); b.onscrollend && b.scrollrunning && b.onscrollend.call(b, { type: 'scrollend', current: { x: e, y: c }, end: { x: b.newscrollx, y: b.newscrolly } }); b.scrollrunning = !1;
        ...
        : (this.doScrollLeft = function (c, g) { const f = b.scrollrunning ? b.newscrolly : b.getScrollTop(); b.doScrollPos(c, f, g); }, this.doScrollTop = function (c,
          ...
          function e () {
            if (b.cancelAnimationFrame) return !0; b.scrollrunning = !0; if (p = 1 - p) return b.timer = v(e) || 1; let c = 0; var d = sy = b.getScrollTop(); if (b.dst.ay) { var d = b.bzscroll ? b.dst.py + b.bzscroll.getNow() * b.dst.ay : b.newscrolly; var f = d - sy; if (f < 0 && d < b.newscrolly || f > 0 && d > b.newscrolly)d = b.newscrolly; b.setScrollTop(d); d == b.newscrolly && (c = 1); } else c = 1; let g = sx = b.getScrollLeft(); if (b.dst.ax) {
              g = b.bzscroll
                ? b.dst.px + b.bzscroll.getNow() *
        b.dst.ax
                : b.newscrollx; f = g - sx; if (f < 0 && g < b.newscrollx || f > 0 && g > b.newscrollx)g = b.newscrollx; b.setScrollLeft(g); g == b.newscrollx && (c += 1);
          ...
          }g = typeof g === 'undefined' || !1 === g
            ? b.getScrollTop(!0)
            : g; if (b.timer && b.newscrolly == g && b.newscrollx == c) return !0; b.timer && w(b.timer); b.timer = 0; const k = b.getScrollTop(); const l = b.getScrollLeft(); ((b.newscrolly - k) * (g - k) < 0 || (b.newscrollx - l) * (c - l) < 0) && b.cancelScroll(); b.newscrolly = g; b.newscrollx = c; if (!b.bouncescroll || !b.rail.visibility)b.newscrolly < 0 ? b.newscrolly = 0 : b.newscrolly > b.page.maxh && (b.newscrolly = b.page.maxh); if (!b.bouncescroll || !b.railh.visibility)b.newscrollx < 0 ? b.newscrollx = 0 : b.newscrollx > b.page.maxw && (b.newscrollx = b.page.maxw); b.dst = {}; b.dst.x = c - l; b.dst.y =
        g - k; b.dst.px = l; b.dst.py = k; let h = Math.round(Math.sqrt(Math.pow(b.dst.x, 2) + Math.pow(b.dst.y, 2))); b.dst.ax = b.dst.x / h; b.dst.ay = b.dst.y / h; let m = 0; let q = h; b.dst.x == 0 ? (m = k, q = g, b.dst.ay = 1, b.dst.py = 0) : b.dst.y == 0 && (m = l, q = c, b.dst.ax = 1, b.dst.px = 0); h = b.getTransitionSpeed(h); f && f <= 1 && (h *= f); b.bzscroll = h > 0 ? b.bzscroll ? b.bzscroll.update(q, h) : new BezierClass(m, q, h, 0, 1, 0, 1) : !1; if (!b.timer) {
        ...
        }, this.cancelScroll = function () { b.timer && w(b.timer); b.timer = 0; b.bzscroll = !1; b.scrollrunning = !1; return b; })
      : (this.doScrollLeft = function (c, g) { const f = b.getScrollTop(); b.doScrollPos(c, f, g); }, this.doScrollTop = function (c, g) {
        const f = b.getScrollLeft(); b.doScrollPos(f,
          c, g);
      }, this.doScrollPos = function (c, g, f) { let e = c > b.page.maxw ? b.page.maxw : c; e < 0 && (e = 0); let k = g > b.page.maxh ? b.page.maxh : g; k < 0 && (k = 0); b.synched('scroll', function () { b.setScrollTop(k); b.setScrollLeft(e); }); }, this.cancelScroll = function () {}); this.doScrollBy = function (c, g) {
    ...
    }; this.doScrollLeftBy = function (c, g) { var f = 0; var f = g ? Math.floor((b.scroll.x - c) * b.scrollratio.x) : (b.timer ? b.newscrollx : b.getScrollLeft(!0)) - c; if (b.bouncescroll) { const e = Math.round(b.view.w / 2); f < -e ? f = -e : f > b.page.maxw + e && (f = b.page.maxw + e); }b.cursorfreezed = !1; px = b.getScrollLeft(!0); if (f < 0 && px <= 0 || f > b.page.maxw && px >= b.page.maxw) return b.noticeCursor(); b.doScrollLeft(f); }; this.doScrollTo =
        function (c, g) { g && Math.round(c * b.scrollratio.y); b.cursorfreezed = !1; b.doScrollTop(c); }; this.checkContentSize = function () { const c = b.getContentSize(); (c.h != b.page.h || c.w != b.page.w) && b.resize(!1, c); }; b.onscroll = function (c) { b.rail.drag || b.cursorfreezed || b.synched('scroll', function () { b.scroll.y = Math.round(b.getScrollTop() * (1 / b.scrollratio.y)); b.railh && (b.scroll.x = Math.round(b.getScrollLeft() * (1 / b.scrollratio.x))); b.noticeCursor(); }); }; b.bind(b.docscroll, 'scroll', b.onscroll); this.doZoomIn = function (c) {
      if (!b.zoomactive) {
        b.zoomactive =
        !0; b.zoomrestore = { style: {} }; let k = 'position top left zIndex backgroundColor marginTop marginBottom marginLeft marginRight'.split(' '); const f = b.win[0].style; let l; for (l in k) { const h = k[l]; b.zoomrestore.style[h] = typeof f[h] !== 'undefined' ? f[h] : ''; }b.zoomrestore.style.width = b.win.css('width'); b.zoomrestore.style.height = b.win.css('height'); b.zoomrestore.padding = { w: b.win.outerWidth() - b.win.width(), h: b.win.outerHeight() - b.win.height() }; g.isios4 && (b.zoomrestore.scrollTop = e(window).scrollTop(), e(window).scrollTop(0));
    ...
    const c = this; this.nc = e; this.steptime = this.lasttime = this.speedy = this.speedx = this.lasty = this.lastx = 0; this.snapy = this.snapx = !1; this.demuly = this.demulx = 0; this.lastscrolly = this.lastscrollx = -1; this.timer = this.chky = this.chkx = 0; this.time = function () { return +new Date(); }; this.reset = function (e, l) {
      c.stop(); const h = c.time(); c.steptime = 0; c.lasttime = h; c.speedx = 0; c.speedy = 0; c.lastx = e; c.lasty = l; c.lastscrollx = -1; c.lastscrolly =
    -1;
      ...
      let h = !1; l < 0 ? (l = 0, h = !0) : l > c.nc.page.maxh && (l = c.nc.page.maxh, h = !0); e < 0
        ? (e = 0, h =
    !0)
        : e > c.nc.page.maxw && (e = c.nc.page.maxw, h = !0); h && c.nc.doScrollPos(e, l, c.nc.opt.snapbackspeed);
      ...
      const l = c.time(); let h = e ? l + e : c.lasttime; e = c.nc.getScrollLeft(); const t = c.nc.getScrollTop(); const b = c.nc.page.maxh; const p = c.nc.page.maxw; c.speedx = p > 0 ? Math.min(60, c.speedx) : 0; c.speedy = b > 0 ? Math.min(60, c.speedy) : 0; h = h && l - h <= 60; if (t < 0 || t > b || e < 0 || e > p)h = !1; e = c.speedx && h ? c.speedx : !1; if (c.speedy && h && c.speedy || e) {
        let g = Math.max(16, c.steptime); g > 50 && (e = g / 50, c.speedx *= e, c.speedy *= e, g = 50); c.demulxy = 0; c.lastscrollx =
    c.nc.getScrollLeft(); c.chkx = c.lastscrollx; c.lastscrolly = c.nc.getScrollTop(); c.chky = c.lastscrolly; let s = c.lastscrollx; let u = c.lastscrolly; const d = function () {
          let e = c.time() - l > 600 ? 0.04 : 0.02; if (c.speedx && (s = Math.floor(c.lastscrollx - c.speedx * (1 - c.demulxy)), c.lastscrollx = s, s < 0 || s > p))e = 0.1; if (c.speedy && (u = Math.floor(c.lastscrolly - c.speedy * (1 - c.demulxy)), c.lastscrolly = u, u < 0 || u > b))e = 0.1; c.demulxy = Math.min(1, c.demulxy + e); c.nc.synched('domomentum2d', function () {
    ...
    set: function (h, c) {
      const k = e.data(h, '__nicescroll') || !1; k && k.ishwscroll
        ? k.setScrollTop(parseInt(c))
        : B.call(h, c); return this;
    }
  ...
  }; (function (e, c, k) { for (let l = 0; l < c.length; l++)k(e, c[l]); })(D.prototype, 'show hide toggle onResize resize remove stop doScrollPos'.split(' '), function (e, c) { e[c] = function () { const e = arguments; return this.each(function () { this[c].apply(this, e); }); }; }); e.fn.getNiceScroll =
    function (h) { return typeof h === 'undefined' ? new D(this) : this[h] && e.data(this[h], '__nicescroll') || !1; }; e.extend(e.expr[':'], { nicescroll: function (h) { return e.data(h, '__nicescroll') ? !0 : !1; } }); e.fn.niceScroll = function (h, c) {
