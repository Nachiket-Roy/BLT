...
(function (factory) {
  ...
  $.extend($.fn, {
    ...
    rules: function (command, argument) {
      ...
      let settings; let staticRules; let existingRules; let data; let param; let filtered;
  ...
  $.extend($.validator, {
    ...
    prototype: {
      ...
      check: function (element) {
        ...
        const rulesCount = $.map(rules, function (n, i) {
          return i;
        }).length;
        let dependencyMismatch = false;
        let val = this.elementValue(element);
        let result; let method; let rule; let normalizer;
    ...
    methods: {
      ...
      remote: function (value, element, param, method) {
        ...
        let validator; let data; let optionDataString;
        ...
        $.ajax($.extend(true, {
          ...
          success: function (response) {
            ...
            let errors; let message; let submitted;
