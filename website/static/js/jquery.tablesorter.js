  ...
  $.extend({
    ...
    function () {
      ...
      function buildCache (table) {
        ...
        const parsers = table.config.parsers;
        const cache = {
          row: [],
          normalized: []
        };
      ...
      function getElementText (config, node) {
        ...
        const $node = $(node);
        const data = $node.attr('data-sort-value');
      ...
      function buildHeaders (table) {
        ...
        const $tableHeaders = $(table.config.selectorHeaders, table).each(function (index) {
      ...
      function multisort (table, sortList, cache) {
        ...
        let dynamicExp = 'sortWrapper = function(a,b) {';
        const l = sortList.length;
      ...
      this.construct = function (settings) {
        return this.each(function () {
          ...
          // declare
          let $this; let $document; let $headers; let cache; let config; const shiftDown = 0;
          let sortOrder;
